...
<div class="container mt-4" style="padding:0">
  ...
  <div class="row">
  <?php
$sql = "SELECT * FROM `kycs` WHERE `is_allowed_on_featured`='YES'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
  // output data of each row
  while($row = $result->fetch_assoc()) {
     echo '<div class="col-md-4 col-sm-4 col-xs-12 shadow p-3 mb-5 bg-white rounded" >';
  ...
  echo "<p>Subscribe to show your restraunt here</p>";
}
$conn->close();
...
<!--End showing featured restraunts here -->
