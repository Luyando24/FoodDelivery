...
<br>
<!--Put co-ordinates here-->
<!--Business Location-->    

<br>
<input type="text" class="form-control" id="lng" placeholder="paste longitude here" >
<br>
<input type="text" class="form-control" id="lat" placeholder="paste longitude here" >
...
function addressAutocomplete(containerElement, callback, options) {
  ...
  inputElement.addEventListener("input", function(e) {
    ...
    var promise = new Promise((resolve, reject) => {
      ...
      var apiKey = "aa09da14472b44869ca9cc43c81f3ef1";
...
document.getElementById('lat').value = currentItems[index].properties.lat;
document.getElementById('lng').value = currentItems[index].properties.lon;
