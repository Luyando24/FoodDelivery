          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Add food</a></li>
              </ul>
            </div>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/forms/allfood.html">All food</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/forms/allorders.html">Pending delivery</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Hi {{Auth::user()->firstname}} {{Auth::user()->lastname}} Welcome to the Clients Dashboard</h3>
...
<div class="col-md-6 grid-margin stretch-card">
  ...
  <!--Livewire Business Profile Starts-->
										...
										<ul class="d-flex flex-column-reverse todo-list todo-list-custom">
											...
											<li class="completed">
												<div class="form-check form-check-flat">
													<label class="form-check-label">
														<input class="checkbox" type="checkbox" checked>
														Duplicate a project for new custgomer
													</label>
												</div>
												<i class="remove ti-close"></i>
											</li>
